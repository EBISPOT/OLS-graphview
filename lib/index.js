 ...
 */
 ...
 //Finally, add also a Listener to the Permalink Button
 	...
 	module.exports =getRelationships=function(){return relationships;};
 	module.exports =getExtendedNodes=function(){return root;};
 	module.exports =fetchNewGraphData=function(webserviceURL){fetchGraphData(webserviceURL); return this;};
 	module.exports =printMsg=function(msg){printMsgToScreen(msg);}
 	...
 	module.exports = visstart=function(DIVname, term, inputNetworkOptions, visoptions){
     console.log("Function visstart")
